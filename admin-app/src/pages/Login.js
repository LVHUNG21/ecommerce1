    ...
    <div className='py-5' style={{ background: "#ffd333", minHeight: "100vh" }}>
      ...
      <div className='my-5 w-25 bg-white rounded-3 mx-auto p-4'>
        ...
        <form action="" onSubmit={formik.handleSubmit}>
          <CustomInput type="text" className='email' label="Email Address" id="email" val={formik.email} onCh={formik.handleChange('email')}
          />
          <div className='error'>
          ...
          <CustomInput type="password" className='password' label="Password" id="pass" val={formik.password} onCh={formik.handleChange('password')}
          />
          <div className="error">
